...
/**
 * Diaz Mozqueda Ivana Yamilet Lobato Alcantar Wilmer Ernesto Urueta Rodrigez
 * Andrea
 */
...
//Ingresar comidas
        ...
        do {
            System.out.println("Numero de platillo: ");
        ...
        System.out.println("------------------------------- Corte de Comidas -------------------------------");
        System.out.println("Cantidad de comidas: " + totalCantidadComidas);
...
// Ingreso de bebidas
        ...
        do {
            System.out.print("Numero de bebida: ");
            elemento = teclado.nextByte();
            bebida = arregloMenuBebida.get(elemento);

            do {
                if (bebida.getExistencias() == 0) {
                    System.out.println("Existencias insuficientes, elige otra bebida.");
                    break;
                } else {
                    System.out.println("Cantidad de " + bebida.getNombre() + "quieres comprar?");
                    cantidad = teclado.nextByte();
            ...
            if (insertar) {
                existenciasPedido = (short) (existenciasPedido - cantidad);
                arregloMenuBebida.get(elemento).setExistencias(existenciasPedido);
                //Agregando a los arreglos de pedido de bebida y cantidad
                pedido.productosPedidosBebida.add(bebida);
                pedido.productosCantidadPedidosBebida.add(cantidad);

                //Calculando el total por el numero de unidades
                totalCantidadBebidas += cantidad;
                totalPrecioBebida += bebida.getPrecio() * cantidad;
                System.out.println("Precio " + bebida.getPrecio() + " x " + cantidad + " =$" + bebida.getPrecio() * cantidad);
            }
        ...
        System.out.println("------------------------------- Corte de bebidas -------------------------------");
        System.out.println("Cantidad de bebidas: " + totalCantidadBebidas);
        System.out.println("Subtotal bebida: $" + totalPrecioBebida);
